...
public interface VISANativeInterface extends Library {
    ...
    int  VI_SPEC_VERSION                     = (int) (0x00500100);
    int  VI_ATTR_RSRC_CLASS                  = (int) (0xBFFF0001);
    int  VI_ATTR_RSRC_NAME                   = (int) (0xBFFF0002);
    int  VI_ATTR_RSRC_IMPL_VERSION           = (int) (0x3FFF0003);
    int  VI_ATTR_RSRC_LOCK_STATE             = (int) (0x3FFF0004);
    int  VI_ATTR_MAX_QUEUE_LENGTH            = (int) (0x3FFF0005);
    int  VI_ATTR_USER_DATA_32                = (int) (0x3FFF0007);
    int  VI_ATTR_FDC_CHNL                    = (int) (0x3FFF000D);
    int  VI_ATTR_FDC_MODE                    = (int) (0x3FFF000F);
    int  VI_ATTR_FDC_GEN_SIGNAL_EN           = (int) (0x3FFF0011);
    int  VI_ATTR_FDC_USE_PAIR                = (int) (0x3FFF0013);
    int  VI_ATTR_SEND_END_EN                 = (int) (0x3FFF0016);
    int  VI_ATTR_TERMCHAR                    = (int) (0x3FFF0018);
    int  VI_ATTR_TMO_VALUE                   = (int) (0x3FFF001A);
    int  VI_ATTR_GPIB_READDR_EN              = (int) (0x3FFF001B);
    int  VI_ATTR_IO_PROT                     = (int) (0x3FFF001C);
    int  VI_ATTR_DMA_ALLOW_EN                = (int) (0x3FFF001E);
    int  VI_ATTR_ASRL_BAUD                   = (int) (0x3FFF0021);
    int  VI_ATTR_ASRL_DATA_BITS              = (int) (0x3FFF0022);
    int  VI_ATTR_ASRL_PARITY                 = (int) (0x3FFF0023);
    int  VI_ATTR_ASRL_STOP_BITS              = (int) (0x3FFF0024);
    int  VI_ATTR_ASRL_FLOW_CNTRL             = (int) (0x3FFF0025);
    int  VI_ATTR_RD_BUF_OPER_MODE            = (int) (0x3FFF002A);
    int  VI_ATTR_RD_BUF_SIZE                 = (int) (0x3FFF002B);
    int  VI_ATTR_WR_BUF_OPER_MODE            = (int) (0x3FFF002D);
    int  VI_ATTR_WR_BUF_SIZE                 = (int) (0x3FFF002E);
    int  VI_ATTR_SUPPRESS_END_EN             = (int) (0x3FFF0036);
    int  VI_ATTR_TERMCHAR_EN                 = (int) (0x3FFF0038);
    int  VI_ATTR_DEST_ACCESS_PRIV            = (int) (0x3FFF0039);
    int  VI_ATTR_DEST_BYTE_ORDER             = (int) (0x3FFF003A);
    int  VI_ATTR_SRC_ACCESS_PRIV             = (int) (0x3FFF003C);
    int  VI_ATTR_SRC_BYTE_ORDER              = (int) (0x3FFF003D);
    int  VI_ATTR_SRC_INCREMENT               = (int) (0x3FFF0040);
    int  VI_ATTR_DEST_INCREMENT              = (int) (0x3FFF0041);
    int  VI_ATTR_WIN_ACCESS_PRIV             = (int) (0x3FFF0045);
    int  VI_ATTR_WIN_BYTE_ORDER              = (int) (0x3FFF0047);
    int  VI_ATTR_GPIB_ATN_STATE              = (int) (0x3FFF0057);
    int  VI_ATTR_GPIB_ADDR_STATE             = (int) (0x3FFF005C);
    int  VI_ATTR_GPIB_CIC_STATE              = (int) (0x3FFF005E);
    int  VI_ATTR_GPIB_NDAC_STATE             = (int) (0x3FFF0062);
    int  VI_ATTR_GPIB_SRQ_STATE              = (int) (0x3FFF0067);
    int  VI_ATTR_GPIB_SYS_CNTRL_STATE        = (int) (0x3FFF0068);
    int  VI_ATTR_GPIB_HS488_CBL_LEN          = (int) (0x3FFF0069);
    int  VI_ATTR_CMDR_LA                     = (int) (0x3FFF006B);
    int  VI_ATTR_VXI_DEV_CLASS               = (int) (0x3FFF006C);
    int  VI_ATTR_MAINFRAME_LA                = (int) (0x3FFF0070);
    int  VI_ATTR_MANF_NAME                   = (int) (0xBFFF0072);
    int  VI_ATTR_MODEL_NAME                  = (int) (0xBFFF0077);
    int  VI_ATTR_VXI_VME_INTR_STATUS         = (int) (0x3FFF008B);
    int  VI_ATTR_VXI_TRIG_STATUS             = (int) (0x3FFF008D);
    int  VI_ATTR_VXI_VME_SYSFAIL_STATE       = (int) (0x3FFF0094);
    int  VI_ATTR_WIN_BASE_ADDR_32            = (int) (0x3FFF0098);
    int  VI_ATTR_WIN_SIZE_32                 = (int) (0x3FFF009A);
    int  VI_ATTR_ASRL_AVAIL_NUM              = (int) (0x3FFF00AC);
    int  VI_ATTR_MEM_BASE_32                 = (int) (0x3FFF00AD);
    int  VI_ATTR_ASRL_CTS_STATE              = (int) (0x3FFF00AE);
    int  VI_ATTR_ASRL_DCD_STATE              = (int) (0x3FFF00AF);
    int  VI_ATTR_ASRL_DSR_STATE              = (int) (0x3FFF00B1);
    int  VI_ATTR_ASRL_DTR_STATE              = (int) (0x3FFF00B2);
    int  VI_ATTR_ASRL_END_IN                 = (int) (0x3FFF00B3);
    int  VI_ATTR_ASRL_END_OUT                = (int) (0x3FFF00B4);
    int  VI_ATTR_ASRL_REPLACE_CHAR           = (int) (0x3FFF00BE);
    int  VI_ATTR_ASRL_RI_STATE               = (int) (0x3FFF00BF);
    int  VI_ATTR_ASRL_RTS_STATE              = (int) (0x3FFF00C0);
    int  VI_ATTR_ASRL_XON_CHAR               = (int) (0x3FFF00C1);
    int  VI_ATTR_ASRL_XOFF_CHAR              = (int) (0x3FFF00C2);
    int  VI_ATTR_WIN_ACCESS                  = (int) (0x3FFF00C3);
    int  VI_ATTR_RM_SESSION                  = (int) (0x3FFF00C4);
    int  VI_ATTR_VXI_LA                      = (int) (0x3FFF00D5);
    int  VI_ATTR_MANF_ID                     = (int) (0x3FFF00D9);
    int  VI_ATTR_MEM_SIZE_32                 = (int) (0x3FFF00DD);
    int  VI_ATTR_MEM_SPACE                   = (int) (0x3FFF00DE);
    int  VI_ATTR_MODEL_CODE                  = (int) (0x3FFF00DF);
    int  VI_ATTR_SLOT                        = (int) (0x3FFF00E8);
    int  VI_ATTR_INTF_INST_NAME              = (int) (0xBFFF00E9);
    int  VI_ATTR_IMMEDIATE_SERV              = (int) (0x3FFF0100);
    int  VI_ATTR_INTF_PARENT_NUM             = (int) (0x3FFF0101);
    int  VI_ATTR_RSRC_SPEC_VERSION           = (int) (0x3FFF0170);
    int  VI_ATTR_INTF_TYPE                   = (int) (0x3FFF0171);
    int  VI_ATTR_GPIB_PRIMARY_ADDR           = (int) (0x3FFF0172);
    int  VI_ATTR_GPIB_SECONDARY_ADDR         = (int) (0x3FFF0173);
    int  VI_ATTR_RSRC_MANF_NAME              = (int) (0xBFFF0174);
    int  VI_ATTR_RSRC_MANF_ID                = (int) (0x3FFF0175);
    int  VI_ATTR_INTF_NUM                    = (int) (0x3FFF0176);
    int  VI_ATTR_TRIG_ID                     = (int) (0x3FFF0177);
    int  VI_ATTR_GPIB_REN_STATE              = (int) (0x3FFF0181);
    int  VI_ATTR_GPIB_UNADDR_EN              = (int) (0x3FFF0184);
    int  VI_ATTR_DEV_STATUS_BYTE             = (int) (0x3FFF0189);
    int  VI_ATTR_FILE_APPEND_EN              = (int) (0x3FFF0192);
    int  VI_ATTR_VXI_TRIG_SUPPORT            = (int) (0x3FFF0194);
    int  VI_ATTR_TCPIP_ADDR                  = (int) (0xBFFF0195);
    int  VI_ATTR_TCPIP_HOSTNAME              = (int) (0xBFFF0196);
    int  VI_ATTR_TCPIP_PORT                  = (int) (0x3FFF0197);
    int  VI_ATTR_TCPIP_DEVICE_NAME           = (int) (0xBFFF0199);
    int  VI_ATTR_TCPIP_NODELAY               = (int) (0x3FFF019A);
    int  VI_ATTR_TCPIP_KEEPALIVE             = (int) (0x3FFF019B);
    int  VI_ATTR_4882_COMPLIANT              = (int) (0x3FFF019F);
    int  VI_ATTR_USB_SERIAL_NUM              = (int) (0xBFFF01A0);
    int  VI_ATTR_USB_INTFC_NUM               = (int) (0x3FFF01A1);
    int  VI_ATTR_USB_PROTOCOL                = (int) (0x3FFF01A7);
    int  VI_ATTR_USB_MAX_INTR_SIZE           = (int) (0x3FFF01AF);
    int  VI_ATTR_PXI_DEV_NUM                 = (int) (0x3FFF0201);
    int  VI_ATTR_PXI_FUNC_NUM                = (int) (0x3FFF0202);
    int  VI_ATTR_PXI_BUS_NUM                 = (int) (0x3FFF0205);
    int  VI_ATTR_PXI_CHASSIS                 = (int) (0x3FFF0206);
    int  VI_ATTR_PXI_SLOTPATH                = (int) (0xBFFF0207);
    int  VI_ATTR_PXI_SLOT_LBUS_LEFT          = (int) (0x3FFF0208);
    int  VI_ATTR_PXI_SLOT_LBUS_RIGHT         = (int) (0x3FFF0209);
    int  VI_ATTR_PXI_TRIG_BUS                = (int) (0x3FFF020A);
    int  VI_ATTR_PXI_STAR_TRIG_BUS           = (int) (0x3FFF020B);
    int  VI_ATTR_PXI_STAR_TRIG_LINE          = (int) (0x3FFF020C);
    int  VI_ATTR_PXI_SRC_TRIG_BUS            = (int) (0x3FFF020D);
    int  VI_ATTR_PXI_DEST_TRIG_BUS           = (int) (0x3FFF020E);
    int  VI_ATTR_PXI_MEM_TYPE_BAR0           = (int) (0x3FFF0211);
    int  VI_ATTR_PXI_MEM_TYPE_BAR1           = (int) (0x3FFF0212);
    int  VI_ATTR_PXI_MEM_TYPE_BAR2           = (int) (0x3FFF0213);
    int  VI_ATTR_PXI_MEM_TYPE_BAR3           = (int) (0x3FFF0214);
    int  VI_ATTR_PXI_MEM_TYPE_BAR4           = (int) (0x3FFF0215);
    int  VI_ATTR_PXI_MEM_TYPE_BAR5           = (int) (0x3FFF0216);
    int  VI_ATTR_PXI_MEM_BASE_BAR0_32        = (int) (0x3FFF0221);
    int  VI_ATTR_PXI_MEM_BASE_BAR1_32        = (int) (0x3FFF0222);
    int  VI_ATTR_PXI_MEM_BASE_BAR2_32        = (int) (0x3FFF0223);
    int  VI_ATTR_PXI_MEM_BASE_BAR3_32        = (int) (0x3FFF0224);
    int  VI_ATTR_PXI_MEM_BASE_BAR4_32        = (int) (0x3FFF0225);
    int  VI_ATTR_PXI_MEM_BASE_BAR5_32        = (int) (0x3FFF0226);
    int  VI_ATTR_PXI_MEM_BASE_BAR0_64        = (int) (0x3FFF0228);
    int  VI_ATTR_PXI_MEM_BASE_BAR1_64        = (int) (0x3FFF0229);
    int  VI_ATTR_PXI_MEM_BASE_BAR2_64        = (int) (0x3FFF022A);
    int  VI_ATTR_PXI_MEM_BASE_BAR3_64        = (int) (0x3FFF022B);
    int  VI_ATTR_PXI_MEM_BASE_BAR4_64        = (int) (0x3FFF022C);
    int  VI_ATTR_PXI_MEM_BASE_BAR5_64        = (int) (0x3FFF022D);
    int  VI_ATTR_PXI_MEM_SIZE_BAR0_32        = (int) (0x3FFF0231);
    int  VI_ATTR_PXI_MEM_SIZE_BAR1_32        = (int) (0x3FFF0232);
    int  VI_ATTR_PXI_MEM_SIZE_BAR2_32        = (int) (0x3FFF0233);
    int  VI_ATTR_PXI_MEM_SIZE_BAR3_32        = (int) (0x3FFF0234);
    int  VI_ATTR_PXI_MEM_SIZE_BAR4_32        = (int) (0x3FFF0235);
    int  VI_ATTR_PXI_MEM_SIZE_BAR5_32        = (int) (0x3FFF0236);
    int  VI_ATTR_PXI_MEM_SIZE_BAR0_64        = (int) (0x3FFF0238);
    int  VI_ATTR_PXI_MEM_SIZE_BAR1_64        = (int) (0x3FFF0239);
    int  VI_ATTR_PXI_MEM_SIZE_BAR2_64        = (int) (0x3FFF023A);
    int  VI_ATTR_PXI_MEM_SIZE_BAR3_64        = (int) (0x3FFF023B);
    int  VI_ATTR_PXI_MEM_SIZE_BAR4_64        = (int) (0x3FFF023C);
    int  VI_ATTR_PXI_MEM_SIZE_BAR5_64        = (int) (0x3FFF023D);
    int  VI_ATTR_PXI_IS_EXPRESS              = (int) (0x3FFF0240);
    int  VI_ATTR_PXI_SLOT_LWIDTH             = (int) (0x3FFF0241);
    int  VI_ATTR_PXI_MAX_LWIDTH              = (int) (0x3FFF0242);
    int  VI_ATTR_PXI_ACTUAL_LWIDTH           = (int) (0x3FFF0243);
    int  VI_ATTR_PXI_DSTAR_BUS               = (int) (0x3FFF0244);
    int  VI_ATTR_PXI_DSTAR_SET               = (int) (0x3FFF0245);
    int  VI_ATTR_PXI_ALLOW_WRITE_COMBINE     = (int) (0x3FFF0246);
    int  VI_ATTR_TCPIP_HISLIP_OVERLAP_EN     = (int) (0x3FFF0300);
    int  VI_ATTR_TCPIP_HISLIP_VERSION        = (int) (0x3FFF0301);
    int  VI_ATTR_TCPIP_HISLIP_MAX_MESSAGE_KB = (int) (0x3FFF0302);
    int  VI_ATTR_TCPIP_IS_HISLIP             = (int) (0x3FFF0303);
    int  VI_ATTR_JOB_ID                      = (int) (0x3FFF4006);
    int  VI_ATTR_EVENT_TYPE                  = (int) (0x3FFF4010);
    int  VI_ATTR_SIGP_STATUS_ID              = (int) (0x3FFF4011);
    int  VI_ATTR_RECV_TRIG_ID                = (int) (0x3FFF4012);
    int  VI_ATTR_INTR_STATUS_ID              = (int) (0x3FFF4023);
    int  VI_ATTR_STATUS                      = (int) (0x3FFF4025);
    int  VI_ATTR_RET_COUNT_32                = (int) (0x3FFF4026);
    int  VI_ATTR_BUFFER                      = (int) (0x3FFF4027);
    int  VI_ATTR_RECV_INTR_LEVEL             = (int) (0x3FFF4041);
    int  VI_ATTR_OPER_NAME                   = (int) (0xBFFF4042);
    int  VI_ATTR_GPIB_RECV_CIC_STATE         = (int) (0x3FFF4193);
    int  VI_ATTR_RECV_TCPIP_ADDR             = (int) (0xBFFF4198);
    int  VI_ATTR_USB_RECV_INTR_SIZE          = (int) (0x3FFF41B0);
    int  VI_ATTR_USB_RECV_INTR_DATA          = (int) (0xBFFF41B1);
    int  VI_ATTR_PXI_RECV_INTR_SEQ           = (int) (0x3FFF4240);
    int  VI_ATTR_PXI_RECV_INTR_DATA          = (int) (0x3FFF4241);
    int  VI_ATTR_USER_DATA                   = (int) (0x3FFF0007);
    int  VI_ATTR_RET_COUNT                   = (int) (0x3FFF4026);
    int  VI_ATTR_WIN_BASE_ADDR_64            = (int) (0x3FFF009B);
    int  VI_ATTR_WIN_SIZE_64                 = (int) (0x3FFF009C);
    int  VI_ATTR_MEM_BASE_64                 = (int) (0x3FFF00D0);
    int  VI_ATTR_MEM_SIZE_64                 = (int) (0x3FFF00D1);
    int  VI_ATTR_WIN_BASE_ADDR               = (int) (0x3FFF0098);
    int  VI_ATTR_WIN_SIZE                    = (int) (0x3FFF009A);
    int  VI_ATTR_MEM_BASE                    = (int) (0x3FFF00AD);
    int  VI_ATTR_MEM_SIZE                    = (int) (0x3FFF00DD);
    int  VI_ATTR_PXI_MEM_BASE_BAR0           = (int) (0x3FFF0221);
    int  VI_ATTR_PXI_MEM_BASE_BAR1           = (int) (0x3FFF0222);
    int  VI_ATTR_PXI_MEM_BASE_BAR2           = (int) (0x3FFF0223);
    int  VI_ATTR_PXI_MEM_BASE_BAR3           = (int) (0x3FFF0224);
    int  VI_ATTR_PXI_MEM_BASE_BAR4           = (int) (0x3FFF0225);
    int  VI_ATTR_PXI_MEM_BASE_BAR5           = (int) (0x3FFF0226);
    int  VI_ATTR_PXI_MEM_SIZE_BAR0           = (int) (0x3FFF0231);
    int  VI_ATTR_PXI_MEM_SIZE_BAR1           = (int) (0x3FFF0232);
    int  VI_ATTR_PXI_MEM_SIZE_BAR2           = (int) (0x3FFF0233);
    int  VI_ATTR_PXI_MEM_SIZE_BAR3           = (int) (0x3FFF0234);
    int  VI_ATTR_PXI_MEM_SIZE_BAR4           = (int) (0x3FFF0235);
    int  VI_ATTR_PXI_MEM_SIZE_BAR5           = (int) (0x3FFF0236);
    int  VI_EVENT_IO_COMPLETION              = (int) (0x3FFF2009);
    int  VI_EVENT_TRIG                       = (int) (0xBFFF200A);
    int  VI_EVENT_SERVICE_REQ                = (int) (0x3FFF200B);
    int  VI_EVENT_CLEAR                      = (int) (0x3FFF200D);
    int  VI_EVENT_EXCEPTION                  = (int) (0xBFFF200E);
    int  VI_EVENT_GPIB_CIC                   = (int) (0x3FFF2012);
    int  VI_EVENT_GPIB_TALK                  = (int) (0x3FFF2013);
    int  VI_EVENT_GPIB_LISTEN                = (int) (0x3FFF2014);
    int  VI_EVENT_VXI_VME_SYSFAIL            = (int) (0x3FFF201D);
    int  VI_EVENT_VXI_VME_SYSRESET           = (int) (0x3FFF201E);
    int  VI_EVENT_VXI_SIGP                   = (int) (0x3FFF2020);
    int  VI_EVENT_VXI_VME_INTR               = (int) (0xBFFF2021);
    int  VI_EVENT_PXI_INTR                   = (int) (0x3FFF2022);
    int  VI_EVENT_TCPIP_CONNECT              = (int) (0x3FFF2036);
    int  VI_EVENT_USB_INTR                   = (int) (0x3FFF2037);
    int  VI_ALL_ENABLED_EVENTS               = (int) (0x3FFF7FFF);
    int  VI_SUCCESS_EVENT_EN                 = (int) (0x3FFF0002);
    int  VI_SUCCESS_EVENT_DIS                = (int) (0x3FFF0003);
    int  VI_SUCCESS_QUEUE_EMPTY              = (int) (0x3FFF0004);
    int  VI_SUCCESS_TERM_CHAR                = (int) (0x3FFF0005);
    int  VI_SUCCESS_MAX_CNT                  = (int) (0x3FFF0006);
    int  VI_SUCCESS_DEV_NPRESENT             = (int) (0x3FFF007D);
    int  VI_SUCCESS_TRIG_MAPPED              = (int) (0x3FFF007E);
    int  VI_SUCCESS_QUEUE_NEMPTY             = (int) (0x3FFF0080);
    int  VI_SUCCESS_NCHAIN                   = (int) (0x3FFF0098);
    int  VI_SUCCESS_NESTED_SHARED            = (int) (0x3FFF0099);
    int  VI_SUCCESS_NESTED_EXCLUSIVE         = (int) (0x3FFF009A);
    int  VI_SUCCESS_SYNC                     = (int) (0x3FFF009B);
    int  VI_WARN_QUEUE_OVERFLOW              = (int) (0x3FFF000C);
    int  VI_WARN_CONFIG_NLOADED              = (int) (0x3FFF0077);
    int  VI_WARN_NULL_OBJECT                 = (int) (0x3FFF0082);
    int  VI_WARN_NSUP_ATTR_STATE             = (int) (0x3FFF0084);
    int  VI_WARN_UNKNOWN_STATUS              = (int) (0x3FFF0085);
    int  VI_WARN_NSUP_BUF                    = (int) (0x3FFF0088);
    int  VI_WARN_EXT_FUNC_NIMPL              = (int) (0x3FFF00A9);
    int  VI_ERROR_SYSTEM_ERROR               = (int) ((-2147483647 - 1) + 0x3FFF0000);
    int  VI_ERROR_INV_OBJECT                 = (int) ((-2147483647 - 1) + 0x3FFF000E);
    int  VI_ERROR_RSRC_LOCKED                = (int) ((-2147483647 - 1) + 0x3FFF000F);
    int  VI_ERROR_INV_EXPR                   = (int) ((-2147483647 - 1) + 0x3FFF0010);
    int  VI_ERROR_RSRC_NFOUND                = (int) ((-2147483647 - 1) + 0x3FFF0011);
    int  VI_ERROR_INV_RSRC_NAME              = (int) ((-2147483647 - 1) + 0x3FFF0012);
    int  VI_ERROR_INV_ACC_MODE               = (int) ((-2147483647 - 1) + 0x3FFF0013);
    int  VI_ERROR_TMO                        = (int) ((-2147483647 - 1) + 0x3FFF0015);
    int  VI_ERROR_CLOSING_FAILED             = (int) ((-2147483647 - 1) + 0x3FFF0016);
    int  VI_ERROR_INV_DEGREE                 = (int) ((-2147483647 - 1) + 0x3FFF001B);
    int  VI_ERROR_INV_JOB_ID                 = (int) ((-2147483647 - 1) + 0x3FFF001C);
    int  VI_ERROR_NSUP_ATTR                  = (int) ((-2147483647 - 1) + 0x3FFF001D);
    int  VI_ERROR_NSUP_ATTR_STATE            = (int) ((-2147483647 - 1) + 0x3FFF001E);
    int  VI_ERROR_ATTR_READONLY              = (int) ((-2147483647 - 1) + 0x3FFF001F);
    int  VI_ERROR_INV_LOCK_TYPE              = (int) ((-2147483647 - 1) + 0x3FFF0020);
    int  VI_ERROR_INV_ACCESS_KEY             = (int) ((-2147483647 - 1) + 0x3FFF0021);
    int  VI_ERROR_INV_EVENT                  = (int) ((-2147483647 - 1) + 0x3FFF0026);
    int  VI_ERROR_INV_MECH                   = (int) ((-2147483647 - 1) + 0x3FFF0027);
    int  VI_ERROR_HNDLR_NINSTALLED           = (int) ((-2147483647 - 1) + 0x3FFF0028);
    int  VI_ERROR_INV_HNDLR_REF              = (int) ((-2147483647 - 1) + 0x3FFF0029);
    int  VI_ERROR_INV_CONTEXT                = (int) ((-2147483647 - 1) + 0x3FFF002A);
    int  VI_ERROR_NENABLED                   = (int) ((-2147483647 - 1) + 0x3FFF002F);
    int  VI_ERROR_ABORT                      = (int) ((-2147483647 - 1) + 0x3FFF0030);
    int  VI_ERROR_RAW_WR_PROT_VIOL           = (int) ((-2147483647 - 1) + 0x3FFF0034);
    int  VI_ERROR_RAW_RD_PROT_VIOL           = (int) ((-2147483647 - 1) + 0x3FFF0035);
    int  VI_ERROR_OUTP_PROT_VIOL             = (int) ((-2147483647 - 1) + 0x3FFF0036);
    int  VI_ERROR_INP_PROT_VIOL              = (int) ((-2147483647 - 1) + 0x3FFF0037);
    int  VI_ERROR_BERR                       = (int) ((-2147483647 - 1) + 0x3FFF0038);
    int  VI_ERROR_IN_PROGRESS                = (int) ((-2147483647 - 1) + 0x3FFF0039);
    int  VI_ERROR_INV_SETUP                  = (int) ((-2147483647 - 1) + 0x3FFF003A);
    int  VI_ERROR_QUEUE_ERROR                = (int) ((-2147483647 - 1) + 0x3FFF003B);
    int  VI_ERROR_ALLOC                      = (int) ((-2147483647 - 1) + 0x3FFF003C);
    int  VI_ERROR_INV_MASK                   = (int) ((-2147483647 - 1) + 0x3FFF003D);
    int  VI_ERROR_IO                         = (int) ((-2147483647 - 1) + 0x3FFF003E);
    int  VI_ERROR_INV_FMT                    = (int) ((-2147483647 - 1) + 0x3FFF003F);
    int  VI_ERROR_NSUP_FMT                   = (int) ((-2147483647 - 1) + 0x3FFF0041);
    int  VI_ERROR_LINE_IN_USE                = (int) ((-2147483647 - 1) + 0x3FFF0042);
    int  VI_ERROR_NSUP_MODE                  = (int) ((-2147483647 - 1) + 0x3FFF0046);
    int  VI_ERROR_SRQ_NOCCURRED              = (int) ((-2147483647 - 1) + 0x3FFF004A);
    int  VI_ERROR_INV_SPACE                  = (int) ((-2147483647 - 1) + 0x3FFF004E);
    int  VI_ERROR_INV_OFFSET                 = (int) ((-2147483647 - 1) + 0x3FFF0051);
    int  VI_ERROR_INV_WIDTH                  = (int) ((-2147483647 - 1) + 0x3FFF0052);
    int  VI_ERROR_NSUP_OFFSET                = (int) ((-2147483647 - 1) + 0x3FFF0054);
    int  VI_ERROR_NSUP_VAR_WIDTH             = (int) ((-2147483647 - 1) + 0x3FFF0055);
    int  VI_ERROR_WINDOW_NMAPPED             = (int) ((-2147483647 - 1) + 0x3FFF0057);
    int  VI_ERROR_RESP_PENDING               = (int) ((-2147483647 - 1) + 0x3FFF0059);
    int  VI_ERROR_NLISTENERS                 = (int) ((-2147483647 - 1) + 0x3FFF005F);
    int  VI_ERROR_NCIC                       = (int) ((-2147483647 - 1) + 0x3FFF0060);
    int  VI_ERROR_NSYS_CNTLR                 = (int) ((-2147483647 - 1) + 0x3FFF0061);
    int  VI_ERROR_NSUP_OPER                  = (int) ((-2147483647 - 1) + 0x3FFF0067);
    int  VI_ERROR_INTR_PENDING               = (int) ((-2147483647 - 1) + 0x3FFF0068);
    int  VI_ERROR_ASRL_PARITY                = (int) ((-2147483647 - 1) + 0x3FFF006A);
    int  VI_ERROR_ASRL_FRAMING               = (int) ((-2147483647 - 1) + 0x3FFF006B);
    int  VI_ERROR_ASRL_OVERRUN               = (int) ((-2147483647 - 1) + 0x3FFF006C);
    int  VI_ERROR_TRIG_NMAPPED               = (int) ((-2147483647 - 1) + 0x3FFF006E);
    int  VI_ERROR_NSUP_ALIGN_OFFSET          = (int) ((-2147483647 - 1) + 0x3FFF0070);
    int  VI_ERROR_USER_BUF                   = (int) ((-2147483647 - 1) + 0x3FFF0071);
    int  VI_ERROR_RSRC_BUSY                  = (int) ((-2147483647 - 1) + 0x3FFF0072);
    int  VI_ERROR_NSUP_WIDTH                 = (int) ((-2147483647 - 1) + 0x3FFF0076);
    int  VI_ERROR_INV_PARAMETER              = (int) ((-2147483647 - 1) + 0x3FFF0078);
    int  VI_ERROR_INV_PROT                   = (int) ((-2147483647 - 1) + 0x3FFF0079);
    int  VI_ERROR_INV_SIZE                   = (int) ((-2147483647 - 1) + 0x3FFF007B);
    int  VI_ERROR_WINDOW_MAPPED              = (int) ((-2147483647 - 1) + 0x3FFF0080);
    int  VI_ERROR_NIMPL_OPER                 = (int) ((-2147483647 - 1) + 0x3FFF0081);
    int  VI_ERROR_INV_LENGTH                 = (int) ((-2147483647 - 1) + 0x3FFF0083);
    int  VI_ERROR_INV_MODE                   = (int) ((-2147483647 - 1) + 0x3FFF0091);
    int  VI_ERROR_SESN_NLOCKED               = (int) ((-2147483647 - 1) + 0x3FFF009C);
    int  VI_ERROR_MEM_NSHARED                = (int) ((-2147483647 - 1) + 0x3FFF009D);
    int  VI_ERROR_LIBRARY_NFOUND             = (int) ((-2147483647 - 1) + 0x3FFF009E);
    int  VI_ERROR_NSUP_INTR                  = (int) ((-2147483647 - 1) + 0x3FFF009F);
    int  VI_ERROR_INV_LINE                   = (int) ((-2147483647 - 1) + 0x3FFF00A0);
    int  VI_ERROR_FILE_ACCESS                = (int) ((-2147483647 - 1) + 0x3FFF00A1);
    int  VI_ERROR_FILE_IO                    = (int) ((-2147483647 - 1) + 0x3FFF00A2);
    int  VI_ERROR_NSUP_LINE                  = (int) ((-2147483647 - 1) + 0x3FFF00A3);
    int  VI_ERROR_NSUP_MECH                  = (int) ((-2147483647 - 1) + 0x3FFF00A4);
    int  VI_ERROR_INTF_NUM_NCONFIG           = (int) ((-2147483647 - 1) + 0x3FFF00A5);
    int  VI_ERROR_CONN_LOST                  = (int) ((-2147483647 - 1) + 0x3FFF00A6);
    int  VI_ERROR_NPERMISSION                = (int) ((-2147483647 - 1) + 0x3FFF00A8);
    int  VI_FIND_BUFLEN                      = (int) (256);
    int  VI_INTF_GPIB                        = (int) (1);
    int  VI_INTF_VXI                         = (int) (2);
    int  VI_INTF_GPIB_VXI                    = (int) (3);
    int  VI_INTF_ASRL                        = (int) (4);
    int  VI_INTF_PXI                         = (int) (5);
    int  VI_INTF_TCPIP                       = (int) (6);
    int  VI_INTF_USB                         = (int) (7);
    int  VI_PROT_NORMAL                      = (int) (1);
    int  VI_PROT_FDC                         = (int) (2);
    int  VI_PROT_HS488                       = (int) (3);
    int  VI_PROT_4882_STRS                   = (int) (4);
    int  VI_PROT_USBTMC_VENDOR               = (int) (5);
    int  VI_FDC_NORMAL                       = (int) (1);
    int  VI_FDC_STREAM                       = (int) (2);
    int  VI_LOCAL_SPACE                      = (int) (0);
    int  VI_A16_SPACE                        = (int) (1);
    int  VI_A24_SPACE                        = (int) (2);
    int  VI_A32_SPACE                        = (int) (3);
    int  VI_A64_SPACE                        = (int) (4);
    int  VI_PXI_ALLOC_SPACE                  = (int) (9);
    int  VI_PXI_CFG_SPACE                    = (int) (10);
    int  VI_PXI_BAR0_SPACE                   = (int) (11);
    int  VI_PXI_BAR1_SPACE                   = (int) (12);
    int  VI_PXI_BAR2_SPACE                   = (int) (13);
    int  VI_PXI_BAR3_SPACE                   = (int) (14);
    int  VI_PXI_BAR4_SPACE                   = (int) (15);
    int  VI_PXI_BAR5_SPACE                   = (int) (16);
    int  VI_OPAQUE_SPACE                     = (int) (0xFFFF);
    int  VI_UNKNOWN_LA                       = (int) (-1);
    int  VI_UNKNOWN_SLOT                     = (int) (-1);
    int  VI_UNKNOWN_LEVEL                    = (int) (-1);
    int  VI_UNKNOWN_CHASSIS                  = (int) (-1);
    int  VI_QUEUE                            = (int) (1);
    int  VI_HNDLR                            = (int) (2);
    int  VI_SUSPEND_HNDLR                    = (int) (4);
    int  VI_ALL_MECH                         = (int) (0xFFFF);
    int  VI_ANY_HNDLR                        = (int) (0);
    int  VI_TRIG_ALL                         = (int) (-2);
    int  VI_TRIG_SW                          = (int) (-1);
    int  VI_TRIG_TTL0                        = (int) (0);
    int  VI_TRIG_TTL1                        = (int) (1);
    int  VI_TRIG_TTL2                        = (int) (2);
    int  VI_TRIG_TTL3                        = (int) (3);
    int  VI_TRIG_TTL4                        = (int) (4);
    int  VI_TRIG_TTL5                        = (int) (5);
    int  VI_TRIG_TTL6                        = (int) (6);
    int  VI_TRIG_TTL7                        = (int) (7);
    int  VI_TRIG_ECL0                        = (int) (8);
    int  VI_TRIG_ECL1                        = (int) (9);
    int  VI_TRIG_ECL2                        = (int) (10);
    int  VI_TRIG_ECL3                        = (int) (11);
    int  VI_TRIG_ECL4                        = (int) (12);
    int  VI_TRIG_ECL5                        = (int) (13);
    int  VI_TRIG_STAR_SLOT1                  = (int) (14);
    int  VI_TRIG_STAR_SLOT2                  = (int) (15);
    int  VI_TRIG_STAR_SLOT3                  = (int) (16);
    int  VI_TRIG_STAR_SLOT4                  = (int) (17);
    int  VI_TRIG_STAR_SLOT5                  = (int) (18);
    int  VI_TRIG_STAR_SLOT6                  = (int) (19);
    int  VI_TRIG_STAR_SLOT7                  = (int) (20);
    int  VI_TRIG_STAR_SLOT8                  = (int) (21);
    int  VI_TRIG_STAR_SLOT9                  = (int) (22);
    int  VI_TRIG_STAR_SLOT10                 = (int) (23);
    int  VI_TRIG_STAR_SLOT11                 = (int) (24);
    int  VI_TRIG_STAR_SLOT12                 = (int) (25);
    int  VI_TRIG_STAR_INSTR                  = (int) (26);
    int  VI_TRIG_PANEL_IN                    = (int) (27);
    int  VI_TRIG_PANEL_OUT                   = (int) (28);
    int  VI_TRIG_STAR_VXI0                   = (int) (29);
    int  VI_TRIG_STAR_VXI1                   = (int) (30);
    int  VI_TRIG_STAR_VXI2                   = (int) (31);
    int  VI_TRIG_PROT_DEFAULT                = (int) (0);
    int  VI_TRIG_PROT_ON                     = (int) (1);
    int  VI_TRIG_PROT_OFF                    = (int) (2);
    int  VI_TRIG_PROT_SYNC                   = (int) (5);
    int  VI_TRIG_PROT_RESERVE                = (int) (6);
    int  VI_TRIG_PROT_UNRESERVE              = (int) (7);
    int  VI_READ_BUF                         = (int) (1);
    int  VI_WRITE_BUF                        = (int) (2);
    int  VI_READ_BUF_DISCARD                 = (int) (4);
    int  VI_WRITE_BUF_DISCARD                = (int) (8);
    int  VI_IO_IN_BUF                        = (int) (16);
    int  VI_IO_OUT_BUF                       = (int) (32);
    int  VI_IO_IN_BUF_DISCARD                = (int) (64);
    int  VI_IO_OUT_BUF_DISCARD               = (int) (128);
    int  VI_FLUSH_ON_ACCESS                  = (int) (1);
    int  VI_FLUSH_WHEN_FULL                  = (int) (2);
    int  VI_FLUSH_DISABLE                    = (int) (3);
    int  VI_NMAPPED                          = (int) (1);
    int  VI_USE_OPERS                        = (int) (2);
    int  VI_DEREF_ADDR                       = (int) (3);
    int  VI_TMO_IMMEDIATE                    = (int) (0);
    long VI_TMO_INFINITE                     = (long) (0xFFFFFFFFL);
    int  VI_NO_LOCK                          = (int) (0);
    int  VI_EXCLUSIVE_LOCK                   = (int) (1);
    int  VI_SHARED_LOCK                      = (int) (2);
    int  VI_LOAD_CONFIG                      = (int) (4);
    int  VI_NO_SEC_ADDR                      = (int) (0xFFFF);
    int  VI_ASRL_PAR_NONE                    = (int) (0);
    int  VI_ASRL_PAR_ODD                     = (int) (1);
    int  VI_ASRL_PAR_EVEN                    = (int) (2);
    int  VI_ASRL_PAR_MARK                    = (int) (3);
    int  VI_ASRL_PAR_SPACE                   = (int) (4);
    int  VI_ASRL_STOP_ONE                    = (int) (10);
    int  VI_ASRL_STOP_ONE5                   = (int) (15);
    int  VI_ASRL_STOP_TWO                    = (int) (20);
    int  VI_ASRL_FLOW_NONE                   = (int) (0);
    int  VI_ASRL_FLOW_XON_XOFF               = (int) (1);
    int  VI_ASRL_FLOW_RTS_CTS                = (int) (2);
    int  VI_ASRL_FLOW_DTR_DSR                = (int) (4);
    int  VI_ASRL_END_NONE                    = (int) (0);
    int  VI_ASRL_END_LAST_BIT                = (int) (1);
    int  VI_ASRL_END_TERMCHAR                = (int) (2);
    int  VI_ASRL_END_BREAK                   = (int) (3);
    int  VI_STATE_ASSERTED                   = (int) (1);
    int  VI_STATE_UNASSERTED                 = (int) (0);
    int  VI_STATE_UNKNOWN                    = (int) (-1);
    int  VI_BIG_ENDIAN                       = (int) (0);
    int  VI_LITTLE_ENDIAN                    = (int) (1);
    int  VI_DATA_PRIV                        = (int) (0);
    int  VI_DATA_NPRIV                       = (int) (1);
    int  VI_PROG_PRIV                        = (int) (2);
    int  VI_PROG_NPRIV                       = (int) (3);
    int  VI_BLCK_PRIV                        = (int) (4);
    int  VI_BLCK_NPRIV                       = (int) (5);
    int  VI_D64_PRIV                         = (int) (6);
    int  VI_D64_NPRIV                        = (int) (7);
    int  VI_D64_2EVME                        = (int) (8);
    int  VI_D64_SST160                       = (int) (9);
    int  VI_D64_SST267                       = (int) (10);
    int  VI_D64_SST320                       = (int) (11);
    int  VI_WIDTH_8                          = (int) (1);
    int  VI_WIDTH_16                         = (int) (2);
    int  VI_WIDTH_32                         = (int) (4);
    int  VI_WIDTH_64                         = (int) (8);
    int  VI_GPIB_REN_DEASSERT                = (int) (0);
    int  VI_GPIB_REN_ASSERT                  = (int) (1);
    int  VI_GPIB_REN_DEASSERT_GTL            = (int) (2);
    int  VI_GPIB_REN_ASSERT_ADDRESS          = (int) (3);
    int  VI_GPIB_REN_ASSERT_LLO              = (int) (4);
    int  VI_GPIB_REN_ASSERT_ADDRESS_LLO      = (int) (5);
    int  VI_GPIB_REN_ADDRESS_GTL             = (int) (6);
    int  VI_GPIB_ATN_DEASSERT                = (int) (0);
    int  VI_GPIB_ATN_ASSERT                  = (int) (1);
    int  VI_GPIB_ATN_DEASSERT_HANDSHAKE      = (int) (2);
    int  VI_GPIB_ATN_ASSERT_IMMEDIATE        = (int) (3);
    int  VI_GPIB_HS488_DISABLED              = (int) (0);
    int  VI_GPIB_HS488_NIMPL                 = (int) (-1);
    int  VI_GPIB_UNADDRESSED                 = (int) (0);
    int  VI_GPIB_TALKER                      = (int) (1);
    int  VI_GPIB_LISTENER                    = (int) (2);
    int  VI_VXI_CMD16                        = (int) (0x0200);
    int  VI_VXI_CMD16_RESP16                 = (int) (0x0202);
    int  VI_VXI_RESP16                       = (int) (0x0002);
    int  VI_VXI_CMD32                        = (int) (0x0400);
    int  VI_VXI_CMD32_RESP16                 = (int) (0x0402);
    int  VI_VXI_CMD32_RESP32                 = (int) (0x0404);
    int  VI_VXI_RESP32                       = (int) (0x0004);
    int  VI_ASSERT_SIGNAL                    = (int) (-1);
    int  VI_ASSERT_USE_ASSIGNED              = (int) (0);
    int  VI_ASSERT_IRQ1                      = (int) (1);
    int  VI_ASSERT_IRQ2                      = (int) (2);
    int  VI_ASSERT_IRQ3                      = (int) (3);
    int  VI_ASSERT_IRQ4                      = (int) (4);
    int  VI_ASSERT_IRQ5                      = (int) (5);
    int  VI_ASSERT_IRQ6                      = (int) (6);
    int  VI_ASSERT_IRQ7                      = (int) (7);
    int  VI_UTIL_ASSERT_SYSRESET             = (int) (1);
    int  VI_UTIL_ASSERT_SYSFAIL              = (int) (2);
    int  VI_UTIL_DEASSERT_SYSFAIL            = (int) (3);
    int  VI_VXI_CLASS_MEMORY                 = (int) (0);
    int  VI_VXI_CLASS_EXTENDED               = (int) (1);
    int  VI_VXI_CLASS_MESSAGE                = (int) (2);
    int  VI_VXI_CLASS_REGISTER               = (int) (3);
    int  VI_VXI_CLASS_OTHER                  = (int) (4);
    int  VI_PXI_ADDR_NONE                    = (int) (0);
    int  VI_PXI_ADDR_MEM                     = (int) (1);
    int  VI_PXI_ADDR_IO                      = (int) (2);
    int  VI_PXI_ADDR_CFG                     = (int) (3);
    int  VI_TRIG_UNKNOWN                     = (int) (-1);
    int  VI_PXI_LBUS_STAR_TRIG_BUS_0         = (int) (1000);
    int  VI_PXI_LBUS_STAR_TRIG_BUS_1         = (int) (1001);
    int  VI_PXI_LBUS_STAR_TRIG_BUS_2         = (int) (1002);
    int  VI_PXI_LBUS_STAR_TRIG_BUS_3         = (int) (1003);
    int  VI_PXI_LBUS_STAR_TRIG_BUS_4         = (int) (1004);
    int  VI_PXI_LBUS_STAR_TRIG_BUS_5         = (int) (1005);
    int  VI_PXI_LBUS_STAR_TRIG_BUS_6         = (int) (1006);
    int  VI_PXI_LBUS_STAR_TRIG_BUS_7         = (int) (1007);
    int  VI_PXI_LBUS_STAR_TRIG_BUS_8         = (int) (1008);
    int  VI_PXI_LBUS_STAR_TRIG_BUS_9         = (int) (1009);
    int  VI_PXI_STAR_TRIG_CONTROLLER         = (int) (1413);
    int  VI_ERROR_INV_SESSION                = (int) ((-2147483647 - 1) + 0x3FFF000E);
    long VI_INFINITE                         = (long) (0xFFFFFFFFL);
    int  VI_NORMAL                           = (int) (1);
    int  VI_FDC                              = (int) (2);
    int  VI_HS488                            = (int) (3);
    int  VI_ASRL488                          = (int) (4);
    int  VI_ASRL_IN_BUF                      = (int) (16);
    int  VI_ASRL_OUT_BUF                     = (int) (32);
    int  VI_ASRL_IN_BUF_DISCARD              = (int) (64);
    int  VI_ASRL_OUT_BUF_DISCARD             = (int) (128);
