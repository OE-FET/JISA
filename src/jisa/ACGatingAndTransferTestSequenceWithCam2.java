...
public class ACGatingAndTransferTestSequenceWithCam2 {
    ...
    static double[] ACGatingLowList = {-50, -1, -50, -1, -50, -1, -50, -1, -50, -1, -50, -1, -50, -1}; //, -30, -70, -40, -1, -80, -60, -1, -35, -75, -65, -1, -45, -55};

    // output directory
    static String outputPath = "D:\\01_iSCAT_Working_Folders\\Yansheng\\run 3";
    // overall test name
    ...
    public static void main(String[] args) throws IOException, DeviceException, InterruptedException {
        ...
        window.addToolbarButton("Start Sequence", ACGatingAndTransferTestSequenceWithCam2::runMeasurementSequence);
        window.addToolbarButton("Stop"          , ACGatingAndTransferTestSequenceWithCam2::onStopButton);
        window.addToolbarButton("Next step"     , ACGatingAndTransferTestSequenceWithCam2::startNextStep);
        window.show();
    }
