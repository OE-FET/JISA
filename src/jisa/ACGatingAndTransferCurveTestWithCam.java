...
public class ACGatingAndTransferCurveTestWithCam {
    ...
    public static void main(String[] args) throws IOException, DeviceException, InterruptedException {
        ...
        ACGatingMeasurement measurement = new ACGatingMeasurement(funcGen, lockInAmp, smu, camera, null);
        measurement.setUseCamera(true);
        measurement.setCameraNFrames(50);
