        ...
        try {
            ...
            for (Action action : actions) {
                ...
                switch (result.getFinalStatus()) {
                    ...
                    case CRITICAL_ERROR:
                        return new Action.Result(Action.Status.CRITICAL_ERROR, messages);

                    case INTERRUPTED:
                        return new Action.Result(Action.Status.INTERRUPTED, messages);
            ...
            return new Action.Result(error ? Action.Status.ERROR : Action.Status.SUCCESS, messages);
