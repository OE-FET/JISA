...
public class Agilent4155 extends VISADevice implements SPA {
    ...
    public Agilent4155(Address address) throws IOException, DeviceException {
    ...
    public void setVoltage(int channel, double voltage) throws DeviceException, IOException {
        ...
        if (states[channel]) {
            write("DV %d,%d,%e,%e", channel + 1, voltageRange[channel].toInt(), voltage, currentComp[channel]);
        }
    }
    ...
    public void setCurrent(int channel, double current) throws DeviceException, IOException {
        ...
        if (states[channel]) {
            write("DI %d,%d,%e,%e", channel + 1, currentRange[channel].toInt(), current, voltageComp[channel]);
        }
    }
