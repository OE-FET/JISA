...
public class Agilent4155B extends AgilentSPA<Agilent4155B> {

    public static String getDescription() {
        return "Agilent 4155B SPA";
    }
    ...
    public Agilent4155B(Address address) throws IOException, DeviceException {

        super(address, true);

        String[]   options      = query("UNT?").split(";");
        List<ASMU> foundSMUs    = new LinkedList<>();
        ASMU[]     possibleSMUs = new AgilentSPA.ASMU[]{SMU1, SMU2, SMU3, SMU4, SMU5, SMU6};
