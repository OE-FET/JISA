...
public class DataDisplay extends JFXElement {
    ...
    private final TableColumn<Parameter, String> name  = new TableColumn<>("Parameter");
    private final TableColumn<Parameter, String> value = new TableColumn<>("Value");

    public DataDisplay(String title) {
