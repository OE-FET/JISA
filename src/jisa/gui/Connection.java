...
public class Connection<T extends Instrument> extends JFXWindow implements Element, IConf<T> {
    ...
    public static class SMU extends Connection<jisa.devices.SMU> {
    ...
    public static class TC extends Connection<jisa.devices.TC> {
    ...
    public static class LockIn extends Connection<jisa.devices.LockIn> {
    ...
    public static class DPLockIn extends Connection<jisa.devices.DPLockIn> {
    ...
    public static class DCPower extends Connection<jisa.devices.DCPower> {
    ...
    public static class VPreAmp extends Connection<jisa.devices.VPreAmp> {
    ...
    public static class VMeter extends Connection<jisa.devices.VMeter> {
    ...
    public static class IMeter extends Connection<jisa.devices.IMeter> {
    ...
    public static class VSource extends Connection<jisa.devices.VSource> {
    ...
    public static class ISource extends Connection<jisa.devices.ISource> {
    ...
    public static class IVMeter extends Connection<jisa.devices.IVMeter> {
    ...
    public static class IVSource extends Connection<jisa.devices.IVSource> {
    ...
    public static class TMeter extends Connection<jisa.devices.TMeter> {
    ...
    public Connection(String title, String key, Class<T> type, ConfigStore c) throws IOException {
