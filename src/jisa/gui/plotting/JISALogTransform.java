 ...
 * @author rstein
 */
public class JISALogTransform extends AbstractAxisTransform {
    ...
    private double logarithmBaseCache = JISALogTransform.DEFAULT_LOGARITHM_BASE;
    ...
    public JISALogTransform(final Axis axis) {
        super(axis);
        rangeMin = JISALogTransform.DEFAULT_LOG_MIN_VALUE;
    }
