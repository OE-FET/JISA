...
public class BinaryResultStream extends ResultTable {
    ...
    private BinaryResultStream(RandomAccessFile file, String path, Column<?>... columns) {
        super(columns);
        this.file = file;
        this.path = path;
    ...
    public BinaryResultStream(Column<?>... columns) throws IOException {
        super(columns);
        initialise(null);
    }

    public BinaryResultStream(String file, Column<?>... columns) throws IOException {
        super(columns);
        initialise(file);
    }

    public BinaryResultStream(String file, String... columns) throws IOException {
