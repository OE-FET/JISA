...
public class DataStream extends DataTable {

    private String           path;
    private RandomAccessFile file;
    private int              currentLine = 0;

    public static DataStream loadFile(String path) throws IOException {
        ...
        DataStream stream = new DataStream(file, path, DataTable.parseColumnHeaderLine(header));
    ...
    private DataStream(RandomAccessFile file, String path, Column<?>... columns) {
        super(columns);
        this.file = file;
        this.path = path;
    }

    public DataStream(Column<?>... columns) throws IOException {
        super(columns);
        initialise(null);
    }

    public DataStream(String file, Column<?>... columns) throws IOException {
        super(columns);
        initialise(file);
    }

    public DataStream(String file, String... columns) throws IOException {
